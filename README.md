...
- `REDIS_DB`
- `REDIS_PREFIX`
- `CACHE_DASHBOARD_VITALS_TTL_SECONDS`
- `CACHE_DASHBOARD_ABNORMAL_REPORT_TTL_SECONDS`
- `CACHE_SLEEP_BY_DATE_TTL_SECONDS`
...
REDIS_DB=0
REDIS_PREFIX=pw
CACHE_DASHBOARD_VITALS_TTL_SECONDS=30
CACHE_DASHBOARD_ABNORMAL_REPORT_TTL_SECONDS=30
CACHE_SLEEP_BY_DATE_TTL_SECONDS=30
```
